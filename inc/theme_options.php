...
function inotek_options_funding( $wp_customize ) {
	...
	$wp_customize->add_setting( 'inotek_funder_link',
		array(
			'type'       => 'option',
			'capability' => 'edit_theme_options',
		) );

	$wp_customize->add_control( 'inotek_funder_link',
		array(
	...
	$wp_customize->add_setting( 'inotek_partner_link',
		array(
			'type'       => 'option',
			'capability' => 'edit_theme_options',
		) );

	$wp_customize->add_control( 'inotek_partner_link',
		array(
