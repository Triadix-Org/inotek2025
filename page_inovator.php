    ...
    <div id="content" class="page-content">
        <div class="container archive-container">
            ...
            <ul class="innovator-category-switch list-inline">
                <li><a href="<?php the_permalink(); ?>" class="category-link"><?php echo __( 'All' ); ?></a></li>
            <?php foreach ( $innovation_categories as $category ): ?>
                <li><a href="<?php echo get_permalink() . '?innovation-status=' . $category->slug; ?>"
                       class="category-link <?php echo ($selected_term_id == $category->term_id) ? 'category-link-active' : '' ?>"><?php echo $category->name ; ?>
                    </a></li>
            <?php endforeach; ?>
            </ul>
	        <?php endif; ?>
