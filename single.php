                                        ...
                                        <ul class="list-unstyled list-inline">
                                            <li>
                                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()); ?>"
                                                    ...
                                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/share-icon-fb.png"
                                                        width="40" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode(get_permalink()); ?>"
                                                    target="_blank" class="article-share-link">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/share-icon-x.png"
                                                        width="40" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://www.instagram.com/inotekfoundation/"
                                                    target="_blank" class="article-share-link">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/share-icon-ig.png"
                                                        width="40" alt="">
                                                </a>
                                            </li>
                                        </ul>
